...
void Seedfinder<external_spacepoint_t, platform_t>::createSeedsForGroup(
  ...
  for (auto cellM : middleSPs) {
    for (auto& spM : *cellM) {
      ...
      //                                                             t_start_duplets)
      //            .count();
      //    std::cout << "|TIMER ACTS| duplets: " << time_elapsed_duplets << "
      //    ns"
      //              << std::endl;
      ...
      for (size_t b = 0; b < numBotSP; b++) {
        ...
        //                                                               t_start_filter1)
        //              .count();
        //      std::cout << "|TIMER ACTS| filter 1: " << time_elapsed_filter1
        //      << " ns"
        //                << std::endl;
      }
      ...
      //                                                             t_start_triplets)
      //            .count();
      //    std::cout << "|TIMER ACTS| triplets + filter 1: " <<
      //    time_elapsed_triplets
      //              << " ns" << std::endl;
      //
      ...
      //                                                             t_start_filter2)
      //            .count();
      //    std::cout << "|TIMER ACTS| filter 2: " << time_elapsed_filter2 << "
      //    ns"
      //              << std::endl;
    }
  }
